...
export interface ProjectMcpConfigRef {
  save: () => Promise<void>;
}
...
export const ProjectMcpConfig = forwardRef<
  ProjectMcpConfigRef,
...
>(
  (
    ...
    const [selectedServer, setSelectedServer] =
      useState<MCPServerWithId | null>(null);
    ...
    const toolListView = selectedServer ? (
      <div className="flex flex-col h-full">
        ...
        <div className="flex justify-between items-center px-4 pb-2 border-b flex-shrink-0">
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <p className="text-xs max-w-xs">
                    <b>Automatic:</b> Assistant can use this tool without
                    asking.
                    <br />
    ...
    return (
      <div className="flex flex-col h-full">
        ...
        {!isCreateMode && mcpServers.length > 0 && renderFooter && (
...
ProjectMcpConfig.displayName = "ProjectMcpConfig";

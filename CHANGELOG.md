...
## [1.5.2](https://github.com/universal-mcp/mcp-client-chatbot/compare/v1.9.0...v1.5.2) (2025-08-06)


### Features

* add assistants tab to the sidebar ([9b1d273](https://github.com/universal-mcp/mcp-client-chatbot/commit/9b1d273f1591147eac8b34561bde48493f2c2732))
* add attach file implementation to individual chats during prompt input ([fe73c17](https://github.com/universal-mcp/mcp-client-chatbot/commit/fe73c17e3d40b7c7df39317458ab64b0cb64e61e))
...
* add default tavily web search tool and http requests tool ([4e3e5b3](https://github.com/universal-mcp/mcp-client-chatbot/commit/4e3e5b3b89d9d17166591d7d2c1a700a4e34ed32))
...
* add forgot/reset password flow ([3ea3ba3](https://github.com/universal-mcp/mcp-client-chatbot/commit/3ea3ba31578152d2f3d98531178dd197f6058eb0))
* add generate from AI capability for automated assistant fields population ([ac62249](https://github.com/universal-mcp/mcp-client-chatbot/commit/ac62249459cbc1928f80c4820202feadc86d766f))
* add generate from AI capability to a thread's export as assistant feature ([a41848b](https://github.com/universal-mcp/mcp-client-chatbot/commit/a41848b82db757170e3dfa4c575a7b394ef851c8))
* add h3, h4 text styles and code block to rich text editor ([d8b210a](https://github.com/universal-mcp/mcp-client-chatbot/commit/d8b210afd5a27f45e76e8aea33cd1e4b1f08cec5))
...
* add markdown edit/preview to assistant instructions text editor ([0180b86](https://github.com/universal-mcp/mcp-client-chatbot/commit/0180b863d44d43a223a77283f8c7726ca1d3a362))
* add model picker for internal testing ([b2cf3af](https://github.com/universal-mcp/mcp-client-chatbot/commit/b2cf3af275c93cf7c3c661e8b8dbad6d6ef3be72))
* add new assistant page, and switcher to the prompt input component ([e9cdc54](https://github.com/universal-mcp/mcp-client-chatbot/commit/e9cdc546072bb224ff5a3e796b0767071c937b28))
...
* add prompt to avoid being too verbose for simple greetings ([29c9c7a](https://github.com/universal-mcp/mcp-client-chatbot/commit/29c9c7a5f70a0acb0ff1883f6e6921f789f7eb7c))
* add python code execution as a tool ([4df87d3](https://github.com/universal-mcp/mcp-client-chatbot/commit/4df87d344ac698d7248812aa58949f0b3a3f64df))
* add rich text editor to assistant instructions section ([5d760f4](https://github.com/universal-mcp/mcp-client-chatbot/commit/5d760f49c147d5f6ccc21b678fcfeb873da2812c))
...
* add share chat functionality, but only viewable by signed in users ([5bba1b6](https://github.com/universal-mcp/mcp-client-chatbot/commit/5bba1b65c8d4187c24467ad22ee0b83f8b4990a4))
...
* add suggestions to homepage chat window ([030626c](https://github.com/universal-mcp/mcp-client-chatbot/commit/030626c9eabf18d0b6e8fb8093855fbf7e64748e))
...
* add view shared chat functionality for all users with a call to action to start own chat ([580fa9f](https://github.com/universal-mcp/mcp-client-chatbot/commit/580fa9fa2f44cad5af9a7ff8db7d241f48076d41))
* **agent:** Increase the max iteration count for react loop ([83d3c1a](https://github.com/universal-mcp/mcp-client-chatbot/commit/83d3c1a81a2f7bb914e0aceedc7fb2d8bb9009cd))
...
* **analytics:** Add posthog analytics to track and monitor activity ([58ca0cb](https://github.com/universal-mcp/mcp-client-chatbot/commit/58ca0cba1a8d083ddf1cec399ecb6b848b1aa593))
* **analytics:** Add posthog analytics to track and monitor activity ([e5f86c8](https://github.com/universal-mcp/mcp-client-chatbot/commit/e5f86c868e648a849bf4bac1993c4021ae00be80))
* **context:** Fix system prompt for context ([4675981](https://github.com/universal-mcp/mcp-client-chatbot/commit/46759813fb5553390201b266fa99db7ffe1a919f))
* **context:** Fix system prompt for context ([09321e4](https://github.com/universal-mcp/mcp-client-chatbot/commit/09321e4fc90d88c0b26a061d817f00e43f332b00))
* **context:** Fix system prompt for context ([9b7d33e](https://github.com/universal-mcp/mcp-client-chatbot/commit/9b7d33eb6222ccc14a66e2cf99525f3a410b6951))
...
* create initial prototype of assistant templates ([693e08d](https://github.com/universal-mcp/mcp-client-chatbot/commit/693e08df04ee11be453a3ba69df6eb55b9e96701))
...
* enforce usage of tools in user system prompt ([0f51688](https://github.com/universal-mcp/mcp-client-chatbot/commit/0f5168840a85e2758cb9b4e7f67016e015d3fb4e))
...
* immediately stream results from assistant page when prompt is entered ([2c37970](https://github.com/universal-mcp/mcp-client-chatbot/commit/2c37970d2e1c9bfc1a464cc1fb3b46bef6908210))
...
* lazily generate title asynchronous to chat streaming ([cd4faaa](https://github.com/universal-mcp/mcp-client-chatbot/commit/cd4faaa557d860efa2b6c2f857ace0e8a06a94ee))
...
* **model:** Fix failing lint errors ([ada8c24](https://github.com/universal-mcp/mcp-client-chatbot/commit/ada8c244ddfb1945b7de9754bd349874a4a33314))
* **model:** switch to anthropic ([da064f4](https://github.com/universal-mcp/mcp-client-chatbot/commit/da064f40dc65ea7cfc2f2d1dd1a6432050f73be3))
* **model:** Switch to bedrock on wingmen.app ([a18df2a](https://github.com/universal-mcp/mcp-client-chatbot/commit/a18df2a4006201bc0a83669f77c274a00e53e633))
* **model:** Use openrouter ([fe18421](https://github.com/universal-mcp/mcp-client-chatbot/commit/fe1842140e7afa62c44a34ffa3fcd1603d165d05))
* modify url for default agentr integration and remove default connectors when any existing servers with lowercase check exist ([1aa7832](https://github.com/universal-mcp/mcp-client-chatbot/commit/1aa7832c8f375106c7fdcae1f982f7eb71b7162b))
...
* select assistant tools from prompt input tools dropdown ([f18ee64](https://github.com/universal-mcp/mcp-client-chatbot/commit/f18ee6445e709add506bb0bfd82361c564529eff))
...
* show thread title and shared by in chat shared page ([d7fa950](https://github.com/universal-mcp/mcp-client-chatbot/commit/d7fa950ad7007ca97410c2fd7477aa1860b6047c))
...
* **staging:** Setup staging env ([0a31df7](https://github.com/universal-mcp/mcp-client-chatbot/commit/0a31df71bc446adb5605875801c0eb03a4c188e2))
...
* use both user and assistant message for title generation ([2e2e36d](https://github.com/universal-mcp/mcp-client-chatbot/commit/2e2e36d4ac187840de16351174e82ec146de575d))
* use last updated time of threads to better sort into sidebar date categories ([1f883bd](https://github.com/universal-mcp/mcp-client-chatbot/commit/1f883bda47c42babf58cd5ad65a74a7fe7372f9b))
* use last updated time of threads to better sort into sidebar date categories ([4c6f770](https://github.com/universal-mcp/mcp-client-chatbot/commit/4c6f770bb32868b79735bec69bc7b96873cbbec3))
* widen view tools modal in mcp integrations page ([2013f95](https://github.com/universal-mcp/mcp-client-chatbot/commit/2013f95a875fdc384f765efbf291cb7ec389f1f1))


### Bug Fixes

* add correct padding between integrations and assistants tab ([4fb94ae](https://github.com/universal-mcp/mcp-client-chatbot/commit/4fb94ae69eda5b06cb2c76e81ed8a8189ae6fcf1))
* add filtering of tool by assistant for voice mode and accurately display voice user messages in chat ([0ad9288](https://github.com/universal-mcp/mcp-client-chatbot/commit/0ad9288c0c9f0ee3823c62f7f90de828855c22c2))
...
* add loader in assistants page, fix text editor height and align assistant cards centered ([ca7ef1c](https://github.com/universal-mcp/mcp-client-chatbot/commit/ca7ef1cab4e905b9e81aedb5c192d66a52c99670))
* add message in voice system prompt to not call tools it does not have access to ([5ef575f](https://github.com/universal-mcp/mcp-client-chatbot/commit/5ef575fb68eeea3c0b0dd688480fb6f915d12460))
* add more prominent thinking animation ([a1b7bd9](https://github.com/universal-mcp/mcp-client-chatbot/commit/a1b7bd93cb42ddc2fc61ca88fbad47fd74496f59))
* add more prominent thinking animation ([582698c](https://github.com/universal-mcp/mcp-client-chatbot/commit/582698cbc52b7fb5fed97481ca3d7a12463f9661))
* add new email verification template and fix session invalidation on successful verification ([d96a6e9](https://github.com/universal-mcp/mcp-client-chatbot/commit/d96a6e9e26717dae178d479e7e108db78c42f12d))
...
* add router replace when chat is started from assistant page and fix generated title not showing in header ([806aa3d](https://github.com/universal-mcp/mcp-client-chatbot/commit/806aa3dfd1f27cc4837ee02c49fc75c99c69bb98))
* add simple spinner while loading a thread ([03ab445](https://github.com/universal-mcp/mcp-client-chatbot/commit/03ab4453560597261c1be23390845e9ee00676c2))
...
* allow scrolling during edit message ([5a53d20](https://github.com/universal-mcp/mcp-client-chatbot/commit/5a53d2074375dbf54c139e38295a8da5ea0ee661))
* allow scrolling within assistants tool config ([982a19a](https://github.com/universal-mcp/mcp-client-chatbot/commit/982a19ab8389e0e3ea26c1db84cbc186c5dc9118))
* apply minor correction to call chatbot as assistant in instructions tab ([39e97f8](https://github.com/universal-mcp/mcp-client-chatbot/commit/39e97f840c8eb2784223cc53f3e13e2cb50c0b8f))
* **assistants:** modify older projects instances to assistants ([c48d3a4](https://github.com/universal-mcp/mcp-client-chatbot/commit/c48d3a439753fd304d932f4b81418052a42ce94d))
* Build fixes ([c2d69da](https://github.com/universal-mcp/mcp-client-chatbot/commit/c2d69da48affac88916558031d0e68c4c7c9409b))
...
* change input schema for thread insert ([618846a](https://github.com/universal-mcp/mcp-client-chatbot/commit/618846acd2310f1580248add1fbe164c8a18ac42))
...
* change title generation model to claude haiku ([e3c288a](https://github.com/universal-mcp/mcp-client-chatbot/commit/e3c288adf348c6b46e488d4065307728f617aa2e))
...
* combine mcp tools fetch for both chat and integrations page ([4fd9799](https://github.com/universal-mcp/mcp-client-chatbot/commit/4fd9799b85dfccc1d56bbed3a399b765a8c998b2))
* combine swr fetch of projects for both sidebar and assistants page ([3074540](https://github.com/universal-mcp/mcp-client-chatbot/commit/3074540da0f15dcaecc7ff43aceafb50ab01a41c))
...
* decouple fetching of user and project instructions from thread details ([e083724](https://github.com/universal-mcp/mcp-client-chatbot/commit/e0837248d9a46c6955febacdf9644af4400d1661))
* display loader for assistant and home page ([3092c70](https://github.com/universal-mcp/mcp-client-chatbot/commit/3092c7029d91cac5f3f64860420dfd17e9b8b920))
* drizzle kit is required for db:push ([b41bd56](https://github.com/universal-mcp/mcp-client-chatbot/commit/b41bd56765834fbfb215aab1aaccd9d017e75793))
* drizzle kit is required for db:push ([e96cdc4](https://github.com/universal-mcp/mcp-client-chatbot/commit/e96cdc422f7c73b45315a792ccf7e8ff8a032d59))
* enable proper disabling of servers even when there are 0 tools available to them in assistant config ([d04cd4d](https://github.com/universal-mcp/mcp-client-chatbot/commit/d04cd4d45a956afaddb69cce6498c0890475d5f9))
...
* filter project tools appropriately in the chat route ([74f5387](https://github.com/universal-mcp/mcp-client-chatbot/commit/74f5387cd2ae24f5a99ab973cbb32743ed25c108))
* fully check user permission before loading workspace settings page ([d7c35fd](https://github.com/universal-mcp/mcp-client-chatbot/commit/d7c35fd0c8db39569b8e1158046469b17c098ace))
...
* handle default tools and mcp tools differently ([c74dfc1](https://github.com/universal-mcp/mcp-client-chatbot/commit/c74dfc1235aea6811b8e539153a399165138e13c))
* have chat title sync with sidebar ([c058737](https://github.com/universal-mcp/mcp-client-chatbot/commit/c058737ac461c6b80e17af5b216e3237f69cc228))
* have consistent loading animation across pages ([41ec64b](https://github.com/universal-mcp/mcp-client-chatbot/commit/41ec64ba40883065313d18f313772ecd3279b578))
...
* increase maxSteps to 30 and retries to 3 in ai sdk ([f9a86bf](https://github.com/universal-mcp/mcp-client-chatbot/commit/f9a86bf95ee6769d23483c09f8ea68266a202564))
...
* make assistant tool config modal responsive to window size ([c9ecf14](https://github.com/universal-mcp/mcp-client-chatbot/commit/c9ecf1466efd67a584365aea3ec22bb61557f328))
* make assistants page not revalidate on mount ([94c18e4](https://github.com/universal-mcp/mcp-client-chatbot/commit/94c18e4b3a34abc4ab846f521bb48dfa7a66c358))
* make call to action button in shared chat sticky to the bottom ([2eee15e](https://github.com/universal-mcp/mcp-client-chatbot/commit/2eee15e14f95ee682f5ab4f6f2462bbfa5c91c26))
* make entire button clickable for assistant selector in sidebar ([b60addd](https://github.com/universal-mcp/mcp-client-chatbot/commit/b60addda3c098ffb93e47234b8f47cc1fd7749b8))
* make integrations page header and loader the same as assistants page ([02a46e7](https://github.com/universal-mcp/mcp-client-chatbot/commit/02a46e72f66d3eaaf0ae3de3301e8a1d2ba5fb3d))
* make internal model switcher work again ([eb31e0f](https://github.com/universal-mcp/mcp-client-chatbot/commit/eb31e0f309b8e51962fce3b33da6a2d308e03e5d))
* make long text overflow-hidden in tiptap component ([b9bfe35](https://github.com/universal-mcp/mcp-client-chatbot/commit/b9bfe35c45a6ca5a7dfd7f53a6326e0d73dc3b58))
...
* make mcp gateway stateless ([0c2444f](https://github.com/universal-mcp/mcp-client-chatbot/commit/0c2444fba14c782d0bffa168367a488f84c782fd))
...
* make package lockfile same version as package.json ([cdbe632](https://github.com/universal-mcp/mcp-client-chatbot/commit/cdbe632f5a739735304f94d1e4a6e4c475315a00))
* make project id param for fetching mcp config non-nullable ([43c0716](https://github.com/universal-mcp/mcp-client-chatbot/commit/43c07163c8ee21446f63a89f136440c517f628c4))
...
* **mcp:** Switch to sse url as its more stable ([9910278](https://github.com/universal-mcp/mcp-client-chatbot/commit/9910278773a186f1c68c23563cfe3708cda51dd6))
...
* modify forgot password error handling ([8024b51](https://github.com/universal-mcp/mcp-client-chatbot/commit/8024b5140ecde1cfa4c21307b65006c3a6274564))
* modify mutate function for thread list updates ([b171615](https://github.com/universal-mcp/mcp-client-chatbot/commit/b1716158679d20400e89e4af53ea6d4112d95f2e))
* modify verified email symbol ([883cf14](https://github.com/universal-mcp/mcp-client-chatbot/commit/883cf140da95e198f6eef1d8b7d39ad7feba0573))
...
* mutate assistants list after update operation ([76d8804](https://github.com/universal-mcp/mcp-client-chatbot/commit/76d8804488085d2e4de6c1c39f03d6b97f906d8f))
* pass org id for removing member action ([73ddf1b](https://github.com/universal-mcp/mcp-client-chatbot/commit/73ddf1b797d7a7dda83a246cc47c656d9648fb4f))
...
* pass selected default tools to chat route ([4bc8316](https://github.com/universal-mcp/mcp-client-chatbot/commit/4bc8316bc20c57a6a183f2289ca8050d44c97681))
* pass undefined for getModel to fallback to default llm model ([22988dd](https://github.com/universal-mcp/mcp-client-chatbot/commit/22988dd68f7e5c7dbea4440e4b7d5d70b69c6dbb))
...
* **rebase:** add new context server prompt to system prompt ([915de51](https://github.com/universal-mcp/mcp-client-chatbot/commit/915de5119d6071801dd66cb2e8a1445e182e81c6))
* recreate package lockfile ([4c5b95f](https://github.com/universal-mcp/mcp-client-chatbot/commit/4c5b95f481f8660d2834b8d72c56d413c77671a6))
* reduce text size of placeholder text in prompt input ([0abfef2](https://github.com/universal-mcp/mcp-client-chatbot/commit/0abfef2ac15b00851f2caa28b2471dadcf7cf904))
* refactor instruction fetching operation to join project table only when project id is not null ([2fbfbae](https://github.com/universal-mcp/mcp-client-chatbot/commit/2fbfbae292db5cd489e941fb3502cde5d092687e))
...
* remove auto scroll for shared chats ([d536687](https://github.com/universal-mcp/mcp-client-chatbot/commit/d5366871721691d564fc78270a83329e1fcfbadf))
* remove document that shows up when long texts are pasted in the prompt input ([fb22536](https://github.com/universal-mcp/mcp-client-chatbot/commit/fb225367baa8edd69a6ee250f8b6bd4edef4e76c))
...
* remove heading from assistant page ([2b44b31](https://github.com/universal-mcp/mcp-client-chatbot/commit/2b44b31a0cd2b1c8694cfa1bb2de93305e6bb725))
* remove loading bubble text from prompt input during tool loading ([6ff6763](https://github.com/universal-mcp/mcp-client-chatbot/commit/6ff6763e822be348aebc20122d4d2115092b3f48))
...
* render tables in markdown ([7789219](https://github.com/universal-mcp/mcp-client-chatbot/commit/7789219b5cf5d5cb5014506165358024f941c1c7))
* resolve 'personal workspace' flashing issue when switching workspaces ([fda576f](https://github.com/universal-mcp/mcp-client-chatbot/commit/fda576faee22e14310a2b398d41e4b62cf4afc74))
...
* separate think animation for chat and layout component ([a1d484b](https://github.com/universal-mcp/mcp-client-chatbot/commit/a1d484bb6544ebc94692741155c5470dedd651d2))
* separate think animation for chat and layout component ([512258d](https://github.com/universal-mcp/mcp-client-chatbot/commit/512258d57bed25d115c9b85bbccf9906c7e85dba))
* set default thread behavior to private in chat route while insertion ([0cef667](https://github.com/universal-mcp/mcp-client-chatbot/commit/0cef6674ae740c4c4b3ca351d45068a2717bba37))
* set timeout for python code execution tool ([7df1326](https://github.com/universal-mcp/mcp-client-chatbot/commit/7df1326072bf38d09874091c21a1432f6907a4d9))
* slightly bias voice and transcription models to favor english ([a1fbb7a](https://github.com/universal-mcp/mcp-client-chatbot/commit/a1fbb7a1e8be20f94eb49780ca4c95c0a56dad82))
...
* switch from openrouter to anthropic ([1265ba8](https://github.com/universal-mcp/mcp-client-chatbot/commit/1265ba8e29dd585c107d522332a3afd8215baa46))
* switch generate title to default claude model ([d39dade](https://github.com/universal-mcp/mcp-client-chatbot/commit/d39dadeaf1109ed4e5bff9c1b9b28ac167616f23))
* switch the deployment targets ([efc9db8](https://github.com/universal-mcp/mcp-client-chatbot/commit/efc9db82541a51502f1f79c9c6b5da1403b324d9))
* Switch to anthropic sonnet 4 ([b3c83fc](https://github.com/universal-mcp/mcp-client-chatbot/commit/b3c83fc70333328bb1a0c4577663a3e760ebb425))
* switch to newly created workspace ([3167a9a](https://github.com/universal-mcp/mcp-client-chatbot/commit/3167a9af1db517f28f93a74365f900d23cf86651))
* switch tool dropdown component to use new mcp server type ([3af73ac](https://github.com/universal-mcp/mcp-client-chatbot/commit/3af73ac926463519ad174c73634053e37a169f2d))
...
* truncate mcp tool descriptions beyond a certain length ([ab16636](https://github.com/universal-mcp/mcp-client-chatbot/commit/ab166365bb43b6cdd3385b8b4874f4025fe51c29))
...
* upload user image to a bucket and save link in db ([ecf4361](https://github.com/universal-mcp/mcp-client-chatbot/commit/ecf43611f6ee83d66d49ed64346c5d2293d6600b))
* wrap long assistant names neatly around card in assistant page ([7929c40](https://github.com/universal-mcp/mcp-client-chatbot/commit/7929c405a2f3677b03ac5ec4f0d514e82467315f))

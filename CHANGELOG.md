...
## [1.5.2](https://github.com/universal-mcp/mcp-client-chatbot/compare/v1.11.0...v1.5.2) (2025-06-30)
...
* add MCP server dropdown component and integrate it into the prompt input for enhanced server management ([aed35f1](https://github.com/universal-mcp/mcp-client-chatbot/commit/aed35f159d2740f5722a06ffc6dd9b1f34cf976d))
...
* enhance manual tool invocation handling and logging ([dacde38](https://github.com/universal-mcp/mcp-client-chatbot/commit/dacde38afe73fda37993e0a435c4f7d9696fc592))
...
* enhance Next.js configuration with cleanDistDir and updated devIndicators ([d5f23a9](https://github.com/universal-mcp/mcp-client-chatbot/commit/d5f23a9ea21af13653b7cd305b9b7594b9146fea))
...
* tool choice menual ([479c00d](https://github.com/universal-mcp/mcp-client-chatbot/commit/479c00df677d59222bef9268251c0d058dfee4d4))
...
* correct spelling of 'manual' in tool invocation handling and related logging ([473b043](https://github.com/universal-mcp/mcp-client-chatbot/commit/473b0435c27377766a01ddd3e83351791372e2c5))
...
* modify MCP client initialization logic to allow configuration without development mode check ([5b1ed12](https://github.com/universal-mcp/mcp-client-chatbot/commit/5b1ed12eddbbc8352d2e35e65bd7ecc7078f7c9c))
...
* set default toolChoice to "auto" in app store and remove unnecessary logging in chat route ([ca3074d](https://github.com/universal-mcp/mcp-client-chatbot/commit/ca3074d924bb3010d0c8529eab2dad8ef8a61c48))
